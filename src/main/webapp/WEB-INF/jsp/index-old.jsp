			...
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					...
					<div class="social">
						...
						<a title="Twitter" href="/auth/twitter"><span class="icon-circle large"><i class="fa fa-twitter"></i></span></a>
						<a title="facebook" href="/auth/facebook"><span class="icon-circle large"><i class="fa fa-facebook"></i></span></a>
						<div class="sideline"></div>
					</div>
					<!--Action button-->
					<p>
